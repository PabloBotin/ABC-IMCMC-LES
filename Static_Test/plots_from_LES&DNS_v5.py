...
# Production rate 
p_Smag = rst_to_array(os.path.join('/Users/pablo/Documents/PABC-MCMC-LES/data_Smagorinsky', f'test-Production_001.rst'))
...
for i in range(3):
    ...
    sigma_Smag_data[i] = rst_to_array(file_sigma_Smag[i])
...
class plots_from_LES:
    ...
    def __init__(self, folder_data, folder_analysis, case):
        ...
        self.production_data = rst_to_array(os.path.join(self.folder_data, f'test-Production_001.rst'))
        self.file_sigma = [[],[],[]] 
        for i in range(3):
