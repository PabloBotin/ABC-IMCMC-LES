...
Description:
------------
Version D from Table 1. Data from production/Sigma, 3 param. C = [-0.04, 0.27, -0.16, 0]
------------
Pope75 static coefficient forward testing

Notes:
------
run `mpiexec -n 4 python ABC_static_test_E.py -h` for help
...
time_group.add_argument('-t', '--tlimit', type=float, default=1,
