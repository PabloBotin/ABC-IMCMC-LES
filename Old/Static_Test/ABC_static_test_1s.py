...
Description:
------------
Version A from Table 1. Data from sigma, 3 param. C= [-0.069, 0.07, 0.0056, 0]
------------
Pope75 static coefficient forward testing

Notes:
------
run `mpiexec -n 4 python ABC_static_test_A.py -h` for help
...
time_group.add_argument('-t', '--tlimit', type=float, default=0.9,
